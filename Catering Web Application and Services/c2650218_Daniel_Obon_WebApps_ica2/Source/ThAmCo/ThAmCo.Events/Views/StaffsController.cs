...
namespace ThAmCo.Events.Views
{
    public class StaffsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StaffId,StaffName,StaffEmail")] Staff staff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StaffId,StaffName,StaffEmail")] Staff staff)
        {
            if (id != staff.StaffId)
            {
                return NotFound();
