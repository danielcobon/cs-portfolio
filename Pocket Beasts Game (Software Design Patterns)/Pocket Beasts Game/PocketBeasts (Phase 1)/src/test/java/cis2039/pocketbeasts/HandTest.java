...
public class HandTest {
    ...
    public void testAdd() {
        ...
        Card cardToAdd = new Card("BR", "Barn Rat", 1, 1, 1);
    ...
    public void testRemoveAll() {
        ...
        cardsToAdd.add(new Card("BR", "Barn Rat", 1, 1, 1));
        cardsToAdd.add(new Card("SP", "Scampering Pup", 2, 2, 1));
    ...
    public void testSort() {
        ...
        ArrayList<Card> sortedCards = instance.getCards();
