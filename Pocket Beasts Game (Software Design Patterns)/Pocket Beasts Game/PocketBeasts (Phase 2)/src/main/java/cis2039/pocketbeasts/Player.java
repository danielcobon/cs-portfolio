...
public class Player {
    ...
    protected final int MAX_MANA = 9;
    
    private final String name;
    
    protected int manaAvailable;
    protected int manaTicker;
    private int health;
    ...
    // Added for Strategy Pattern (ManaStrategy)
    public int getManaTicker() {
        return this.manaTicker;
    }
    
    // Added for Strategy Pattern (HealStrategy)
