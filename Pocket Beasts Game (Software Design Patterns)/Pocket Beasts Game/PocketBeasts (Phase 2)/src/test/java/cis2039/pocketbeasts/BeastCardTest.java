...
public class BeastCardTest {
    ...
    /**
     * Test of getId method, of class BeastCard.
     */
    @Test
    public void testGetId() {
        ...
        for (int i = 0; i < STARTER_CARDS.length; i++) {
            BeastCard instance = STARTER_CARDS[i];
    ...
    /**
     * Test of getName method, of class BeastCard.
     */
    @Test
    ...
    /**
     * Test of getManaCost method, of class BeastCard.
     */
    @Test
    ...
    /**
     * Test of getTag method, of class BeastCard.
     */
    @Test
    public void testGetTag() {
        System.out.println("getTag");

        // Expected Tags corresponding to the STARTER_CARDS array
        String[] expectedTags = {
            "-", "-", "-", "-",
            "Heal: 1", "-", "-", "Mana: 1"
        };

        // Iterate through the each card Tag in the Starter Deck
        for (int i = 0; i < STARTER_CARDS.length; i++) {
            BeastCard instance = STARTER_CARDS[i];
            String expResult = expectedTags[i];
            String result = instance.getTag();
            assertEquals("Testing card tag: " + expResult, expResult, result);
        }
    }
    ...
    public void testDamage() {
        ...
        for (int[] testCase : testCases) {
            ...
            BeastCard instance = STARTER_CARDS[cardIndex];
    ...
    public void testToString() {
        ...
        String[] expectedStrings = {
            "Barn Rat (BR) Mana Cost/1 Attack/1 Health/1 Effect/-",
            "Scampering Pup (SP) Mana Cost/2 Attack/2 Health/1 Effect/-",
            "Hardshell Beetle (HB) Mana Cost/2 Attack/1 Health/2 Effect/-",
            "Vicious House Cat (VHC) Mana Cost/3 Attack/3 Health/2 Effect/-",
            "Guard Dog (GD) Mana Cost/3 Attack/2 Health/3 Effect/Heal: 1",
            "All Round Hound (ARH) Mana Cost/3 Attack/3 Health/3 Effect/-",
            "Moor Owl (MO) Mana Cost/4 Attack/4 Health/2 Effect/-",
            "Highland Tiger (HT) Mana Cost/5 Attack/4 Health/4 Effect/Mana: 1"
        };
    ...
    /**
     * Test of compareTo method, of class BeastCard.
     */
    @Test
    public void testCompareTo() {
        ...
        for (Object[] testCase : testCases) {
            BeastCard instance = (BeastCard) testCase[0];
            BeastCard otherCard = (BeastCard) testCase[1];
